# Deep Build — Netdata borrowables

**Run:** `deep-build/netdata-borrowables`
**Main product:** worktree `/Users/os/repos/worktrees/crumbtrail-netdata`, branch `deep-build/netdata-borrowables`, base `bf7a9b8a`
**CLI / SDK:** worktree `/Users/os/repos/worktrees/crumbtrail-cli-netdata`, branch `deep-build/netdata-borrowables`, base `4038928`
...
`node scripts/dev-harness/link.mjs link --target /Users/os/repos/worktrees/crumbtrail-netdata`
...
Worktree `/Users/os/repos/worktrees/crumbtrail-netdata`. Run tests from the touched package dir.
...
### Verification
```
cd /Users/os/repos/worktrees/crumbtrail-netdata/packages/cloud
...
### Verification
```
cd /Users/os/repos/worktrees/crumbtrail-netdata/packages/evidence-brief
...
### Goal
Netdata's false positive fix was unanimity across independent models, not threshold tuning. The
...
### Goal
Netdata replays 7 days of real history through an alert definition before it is deployed, showing
...
- The MCP tools (CP-V2).
- Auto remediation. Netdata's explicit non goal, and ours.
...
### Verification
```
cd /Users/os/repos/worktrees/crumbtrail-netdata/landing/web && pnpm vitest run lib/copy.test.ts lib/relaunch-copy.test.ts lib/blog/blog-copy.test.ts
cd /Users/os/repos/worktrees/crumbtrail-netdata && pnpm verify:positioning-language && pnpm verify:quickstart-docs
...
Worktree `/Users/os/repos/worktrees/crumbtrail-cli-netdata`.
...
### Verification
```
cd /Users/os/repos/worktrees/crumbtrail-cli-netdata/packages/core
...
cd /Users/os/repos/worktrees/crumbtrail-cli-netdata && grep -rn "CaptureDirective" packages/ || echo "clean"
```
...
- Scoring over anomaly flags. **There is no per event anomaly flag in this product** — verified,
  ...
  never on events. Netdata's third mode has no substrate here; do not fake one.
...
### Verification
```
cd /Users/os/repos/worktrees/crumbtrail-cli-netdata/packages/node
...
### Goal
Netdata ships 49+ installable skills that pair archetype knowledge with the exact queries to run.
...
### Verification
```
cd /Users/os/repos/worktrees/crumbtrail-cli-netdata
...
`/Users/os/repos/worktrees/crumbtrail-netdata/fables-analysis/failure-archetypes-universal.md`
